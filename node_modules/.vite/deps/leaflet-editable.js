  ...
  "node_modules/leaflet-editable/src/Leaflet.Editable.js"(exports, module) {
    ((factory, window2) => {
      ...
      L.Editable = L.Evented.extend({
        ...
        drawing: function() {
          var _a;
          return (_a = this._drawingEditor) == null ? void 0 : _a.drawing();
        },
        // 🍂method stopDrawing()
        ...
        createLayer: function(klass, latlngs, options) {
          ...
          this.fireAndForward("editable:created", { layer });
          return layer;
        },
        createPolyline: function(latlngs, options) {
          return this.createLayer(
            (options == null ? void 0 : options.polylineClass) || this.options.polylineClass,
            latlngs,
            options
          );
        },
        createPolygon: function(latlngs, options) {
          return this.createLayer(
            (options == null ? void 0 : options.polygonClass) || this.options.polygonClass,
            latlngs,
            options
          );
        },
        createMarker: function(latlng, options) {
          return this.createLayer(
            (options == null ? void 0 : options.markerClass) || this.options.markerClass,
            latlng,
            options
          );
        },
        createCircleMarker: function(latlng, options) {
          return this.createLayer(
            (options == null ? void 0 : options.circleMarkerClass) || this.options.circleMarkerClass,
            latlng,
            options
          );
        },
        createRectangle: function(bounds, options) {
          return this.createLayer(
            (options == null ? void 0 : options.rectangleClass) || this.options.rectangleClass,
            bounds,
            options
          );
        },
        createCircle: function(latlng, options) {
          return this.createLayer(
            (options == null ? void 0 : options.circleClass) || this.options.circleClass,
            latlng,
            options
          );
        }
      ...
      L.Editable.VertexMarker = L.Marker.extend({
        ...
        onDrag: function(e) {
          ...
          if (next == null ? void 0 : next.middleMarker) next.middleMarker.updateLatLng();
        },
      ...
      L.Editable.PathEditor = L.Editable.BaseEditor.extend({
        ...
        deleteShape: function(shape, latlngs) {
          ...
          this.refresh();
          this.reset();
          this.fireAndForward("editable:shape:deleted", { shape });
          this.onEdited();
          return shape;
        },
      ...
      const EditableMixin = {
        createEditor: function(map) {
          var _a;
          map = map || this._map;
          const tools = ((_a = this.options.editOptions) == null ? void 0 : _a.editTools) || map.editTools;
        ...
        editEnabled: function() {
          var _a;
          return (_a = this.editor) == null ? void 0 : _a.enabled();
        },
        // 🍂method disableEdit()
      ...
      const PolylineMixin = {
        getEditorClass: (tools) => {
          var _a;
          return ((_a = tools == null ? void 0 : tools.options) == null ? void 0 : _a.polylineEditorClass) || L.Editable.PolylineEditor;
        },
      ...
      const PolygonMixin = {
        getEditorClass: (tools) => {
          var _a;
          return ((_a = tools == null ? void 0 : tools.options) == null ? void 0 : _a.polygonEditorClass) || L.Editable.PolygonEditor;
        },
        shapeAt: function(latlng, latlngs) {
          let shape = null;
          latlngs = latlngs || this._latlngs;
      ...
      const MarkerMixin = {
        getEditorClass: (tools) => {
          var _a;
          return ((_a = tools == null ? void 0 : tools.options) == null ? void 0 : _a.markerEditorClass) || L.Editable.MarkerEditor;
        }
      };
      const CircleMarkerMixin = {
        getEditorClass: (tools) => {
          var _a;
          return ((_a = tools == null ? void 0 : tools.options) == null ? void 0 : _a.circleMarkerEditorClass) || L.Editable.CircleMarkerEditor;
        }
      };
      const RectangleMixin = {
        getEditorClass: (tools) => {
          var _a;
          return ((_a = tools == null ? void 0 : tools.options) == null ? void 0 : _a.rectangleEditorClass) || L.Editable.RectangleEditor;
        }
      };
      const CircleMixin = {
        getEditorClass: (tools) => {
          var _a;
          return ((_a = tools == null ? void 0 : tools.options) == null ? void 0 : _a.circleEditorClass) || L.Editable.CircleEditor;
        }
      };
